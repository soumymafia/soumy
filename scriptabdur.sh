...
state=SOEKABOEMI
locality=JAWA BARAT
organization=www.SoumyMafia.id
organizationalunit=www.SoumyMafia.id
commonname=www.SoumyMafia.IT
email=admin@SoumyR.co.it
...
echo "echo by SOUMYMAFIA" >> .profile
...
echo "<pre>Setup by Soumy</pre>" > /home/vps/public_html/index.html
